...
module.exports = {
  ...
  fn: function parseNativeQueryError(inputs, exits) {
    ...
    // --o--o--o--o--o--o--o--o--o--o--o--o--o--o--o--o--o--o--o-<>
    if (err.code === 'EREQUEST' && err.message.match(/Violation of UNIQUE KEY constraint/)) {
      ...
      // the MSSQL error message and extracting the relevant bits.
      // (See also: https://github.com/balderdashy/sails-mssql/blob/2c414f1191c3595df2cea8e40259811eb3ca05f9/lib/adapter.js#L1223)
      if (_.isString(err.message)) {

        var matches = err.message.match(/^Violation of UNIQUE KEY constraint '(.*)'. Cannot insert duplicate key in object '.*'. The duplicate key value is \(.*\)\.$/);
