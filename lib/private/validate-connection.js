module.exports = require('machine').build({
  ...
  description: 'Check if this looks like a valid MSSQL connection instance.',
  ...
  exits: {
    ...
    success: {
      outputFriendlyName: 'Is probably MSSQL connection',
      outputDescription: 'If the provided appears to be a valid MSSQL connection instance.',
      outputExample: true
    },
