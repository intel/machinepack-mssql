module.exports = {
  ...
  moreInfoUrl: 'https://docs.microsoft.com/en-us/sql/t-sql/language-elements/commit-transaction-transact-sql?view=sql-server-2017',
  ...
  fn: async function commitTransaction(inputs, exits) {
    if (!inputs.connection.currentTransaction) {
      return exits.error(new Error('Transaction is gone. can\'t commit'));
    }

    await inputs.connection.currentTransaction.commit();
    delete inputs.connection.currentTransaction;
