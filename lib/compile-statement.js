...
module.exports = {
  ...
  exits: {
    ...
    notSupported: {
      ...
      extendedDescription: 'If even one clause of the Waterline statement is not supported by the MSSQL driver, the compilation of the entire statement _always fails_.',
      outputVariableName: 'report',
