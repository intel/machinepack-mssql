...
module.exports = {
  ...
  inputs: {
    ...
    statement: {
      ...
      extendedDescription: 'See documentation for more information. Note that `opts` may ' +
        'be used for expressing driver-specific customizations as a sibling to `from`, `where`, ' +
        '`select`, etc. In other words, recursively deep within a Waterline query statement. ' +
    ...
    meta: {
      ...
      extendedDescription: 'This is reserved for custom driver-specific extensions. Please refer to ' +
        'the documentation for the driver you are using for more specific information.',
      example: '==='
    }
